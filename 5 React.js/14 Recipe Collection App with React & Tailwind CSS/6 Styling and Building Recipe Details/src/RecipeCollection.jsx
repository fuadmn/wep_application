import React, { useState } from 'react'
 ...
 const categories = ["all","breakfast","lunch","dinner","dessert"]
  ...
  const filteredRecipe = selectCategory == "all" ? recipes : recipes.filter(recipe => recipe.category === selectCategory)
              ...
              filteredRecipe.map(recipe => (
                 ...
                 <div className="p-6">
                  <div className="flex items-center justify-between">
                    <h2 className='text-xl font-semibold text-gray-8--'>{recipe.title}</h2>
                    ...
                    <div className="flex gap-4 mb-4">
                      ...
                      <span className={`text-sm px-2 py-1 rounded-full ${getDifficultyColor(recipe.difficulty)}`}>{recipe.difficulty}</span>               
                    </div>
                      ...
                      <div >
                          ...
                          
                        {
                            ...
                            <span key={index} className='px-2 py-1 bg-gray-100 rounded-full text-gray-700 text-sm'>{ingredient}</span>
                          ))
                        }
                        </div> 
...

          {
            filteredRecipe.length === 0 && (
              <div className="text-center py-12">
                <p className='text-gray-599'>No recipes found in this category.</p>
              </div>
