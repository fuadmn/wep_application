            ...
            {isLoggedIn ? (
             <>
              ...
              <div className="relative">
                    ...
                    {/* dropDown menu */}
                      {isDropdownOpen && ( 
                    <div className="absolute right-0 w-48  mt-1 rounded-md shadow bg-white z-50"
                     onMouseLeave={() => setIsDropdownOpen(false)}
                     >
                      <div className="absolute h-3 w-full top{[12px] "></div>
                         <Link  className="block px-4 py-2 text-s text-gray-700 hover:text-gray-100">Your Profile</Link>
                         <Link  className="block px-4 py-2 text-s text-gray-700 hover:bg-gray-100">Manage Articles</Link>
                         <Link  className="block px-4 py-2 text-s text-gray-700 hover:bg-gray-100">Signin</Link>
                    </div>
                    )}
              </div>
             </>
