          ...
          <div className="flex items-center space-x-4">
            ...
            {isLoggedIn ? (
             ...
             <div className='items-center space-x-4'>
                      ...
                      <Link to="/signup" className='hidden sm:inline-flex items-center justify-center px-4 py-2 border text-sm font-medium rounded-md border-orange-600 hover:bg-orange-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500'>Sing Up</Link>
